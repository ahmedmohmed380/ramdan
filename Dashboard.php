...
<section class="container py-2 mb-4">
  <div class="row">
    ...
    <!-- left side Area End -->
    <!-- ٌright side Area Start -->
     <div class="col-lg-10">
       <h1>أفضل المنشورات</h1>
